...
class LicenseCoordinator implements LicenseGateController {
  ...
  Future<LicenseGateResult> _acceptOnline(
    ...
    final state = StoredLicenseState(
      ...
      licenseExpiresAt: snapshot.licenseExpiresAt,
      maxDevices: snapshot.maxDevices,
      deviceName: _runtime.deviceName,
      deviceActivatedAt: snapshot.deviceActivatedAt,
      deviceLastSeenAt: snapshot.deviceLastSeenAt,
